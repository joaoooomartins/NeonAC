...
/**
 * Holds the active {@link VersionAdapter} per Minecraft version. Core registers a
 * safe fallback; the {@code earac-versions} module registers precise adapters when loaded.
 */
public final class VersionAdapterRegistry {
    ...
    /**
     * Generic adapter used when no precise adapter is registered. Uses modern-ish
     * constants; safe but conservative.
     */
