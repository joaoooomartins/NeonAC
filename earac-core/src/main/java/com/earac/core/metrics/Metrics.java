package com.earac.core.metrics;

import java.util.concurrent.atomic.AtomicLong;
import java.util.concurrent.atomic.LongAdder;

/**
 * Internal telemetry. Can be fully disabled via {@code metrics.enabled}. All counters
 * are lock-free to avoid impacting hot paths.
 */
