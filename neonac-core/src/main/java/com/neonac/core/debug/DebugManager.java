...
public final class DebugManager {
    ...
    public String snapshot(NeonACPlayer p, MovementEngine movement, ViolationManager vl) {
        double[] pos = p.getPosition();
        double[] delta = p.getDelta();
        StringBuilder sb = new StringBuilder();
        sb.append("&b== NeonAC Debug: ").append(p.getName()).append(" ==\n");
