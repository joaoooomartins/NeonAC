...
/**
 * Represents a Minecraft version, independent of protocol and server implementation.
 * Used to isolate version-specific behaviour behind adapters.
 */
public enum MinecraftVersion {
    ...
    /**
     * @return the numeric "minor" key used in per-version config (e.g. 1.8 -> 8, 1.20 -> 20).
     */
