...
import com.neonac.checks.movement.InvalidSprint;
...
import com.neonac.checks.player.DuplicateRotPlace;
import com.neonac.checks.player.FabricatedPlace;
import com.neonac.checks.player.FarPlace;
...
import com.neonac.checks.player.InvalidPlaceA;
import com.neonac.checks.player.InvalidPlaceB;
import com.neonac.checks.player.InventoryClick;
import com.neonac.checks.player.AirLiquidPlace;
import com.neonac.checks.player.MultiPlace;
import com.neonac.checks.player.Nuker;
import com.neonac.checks.player.PositionPlace;
import com.neonac.checks.player.RotationPlace;
...
public final class NeonACCheckProvider implements CheckProvider {
    ...
    public void registerChecks(CheckRegistry registry) {
        ...
        registry.register(new InvalidSprint(engine));
        ...
        registry.register(new FarPlace(engine));
        registry.register(new InvalidPlaceA(engine));
        registry.register(new InvalidPlaceB(engine));
        registry.register(new AirLiquidPlace(engine));
        registry.register(new MultiPlace(engine));
        registry.register(new FabricatedPlace(engine));
        registry.register(new PositionPlace(engine));
        registry.register(new RotationPlace(engine));
        registry.register(new DuplicateRotPlace(engine));
