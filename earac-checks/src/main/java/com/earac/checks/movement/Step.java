...
/**
 * Step: detects climbing a full block in a single move (vanilla auto-step is ~0.6).
 * Legitimate step uses stairs/slabs; an abrupt ~1-block rise with little horizontal
 * movement is anomalous.
 */
