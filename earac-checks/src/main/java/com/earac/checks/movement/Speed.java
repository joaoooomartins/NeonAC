...
/**
 * Speed: detects horizontal displacement beyond the physics-predicted maximum for the
 * player's environment (ground/air, sprint, ice, slime, speed potion). Confidence scales
 * with the magnitude of the excess.
 */
